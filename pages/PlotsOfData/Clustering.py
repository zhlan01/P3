...
Layout = dbc.Container([
    ...
    dcc.Store(id='[PlotsOfData/Clustering]data_linkage_method', data="ward"),
    dcc.Store(id='[PlotsOfData/Clustering]data_x_axis', data=[None, None]),
    dcc.Store(id='[PlotsOfData/Clustering]data_y_axis', data=[None, None]),
    dcc.Store(id='[PlotsOfData/Clustering]open_time', data=0),
    ...
    dbc.Row([
            ...
            dbc.Card([
                html.Div(
                    [
                        ...
                        dbc.RadioItems(
                            id="[PlotsOfData/Clustering]clustering_method",
                            options=[
                        ...
                        html.Div(id="[PlotsOfData/Clustering]linkage_method_div"),

                        # dbc.Checklist(id='[PlotsOfData/Clustering]show_contributions', options=[
                        #     {"label": "Show contributions per condition", "value": 1}
                        # ]),

                        html.Strong("Number of clusters/groups:"),
                        dbc.Input(id="[PlotsOfData/Clustering]number_of_clusters", value="2"),

                        html.Div(id="[PlotsOfData/Clustering]verify_clustering_div"),

                        html.Br(),
                        html.Strong("Plot Layout"),
                        html.Br(),

                        html.Div(id="[PlotsOfData/Clustering]xy_axis_div"),

                        # dbc.Button("Download clustered data(csv)", id="[PlotsOfData/Clustering]download_data"),
                    ]
                ),
            ], body=True),
        ], md=Pannel_Left),
        ...
        dbc.Col([
            ...
            html.Br(),
            html.Div(id="[PlotsOfData/Clustering]graph"),
        ], md=Pannel_Rignt),
    ]),
...
# 画图
@app.callback(
    Output("[PlotsOfData/Clustering]graph", "children"),
    Output("[PlotsOfData/Clustering]xy_axis_div", "children"),
    Input("[PlotsOfData]data_input", 'data'),
    State("[PlotsOfData]data_tiny", "data"),
    Input("[PlotsOfData/Clustering]number_of_clusters", 'value'),
    Input("[PlotsOfData/Clustering]clustering_method", 'value'),
    Input("[PlotsOfData/Clustering]data_linkage_method", "data"),
    Input("[PlotsOfData/Clustering]data_x_axis", 'value'),
    Input("[PlotsOfData/Clustering]data_y_axis", 'value'),
)
def set_plotly(data_file_content_store, data_tiny_store, number_of_clusters, clustering_method, linkage_method, data_x_axis, data_y_axis):
    ...
    xy_div = [
        ...
        dcc.RangeSlider(
            ...
            value=data_x_axis,
            id='[PlotsOfData/Clustering]x_axis',
        ...
        dcc.RangeSlider(
            ...
            value=data_y_axis,
            id='[PlotsOfData/Clustering]y_axis',
            tooltip={"placement": "bottom", "always_visible": True}
        ),
...
@app.callback(
    Output("[PlotsOfData/Clustering]data_x_axis", 'value'),
    Input("[PlotsOfData/Clustering]x_axis", 'value'),
)
...
@app.callback(
    Output("[PlotsOfData/Clustering]data_y_axis", 'value'),
    Input("[PlotsOfData/Clustering]y_axis", 'value'),
)
...
@app.callback(
    Output("[PlotsOfData/Clustering]linkage_method_div", "children"),
    Input("[PlotsOfData/Clustering]clustering_method", 'value'),
)
def div_linkage_method(clustering_method):
    if clustering_method == "k-means":
        ...
        return [
            ...
            dbc.RadioItems(
                id="[PlotsOfData/Clustering]linkage_method",
                options=[
...
@app.callback(
    Output("[PlotsOfData/Clustering]data_linkage_method", "data"),
    Input("[PlotsOfData/Clustering]linkage_method", 'value'),
)
