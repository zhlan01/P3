...
Layout = dbc.Container([
    ...
    dcc.Store(id='[PlotsOfData/DataSummary]open_time', data=0),
            ...
            dbc.Card([
                html.Div(
                    [
                        ...
                        dbc.Checklist(
                            id="[PlotsOfData/DataSummary]check_show",
                            options=[{"label": i, "value": i} for i in statistics_for_table],
                            value=["median", "MAD", "95CI median"]
                        ),

                        html.Br(),

                        html.Strong("Digits:"),
                        dbc.Input(id="[PlotsOfData/DataSummary]digits", value=2),

                        #
                        # html.Strong("Normalization"),
                        # dbc.Checklist(id='[PlotsOfData/DataSummary]DNormalization', options=[
                        #     {"label": "Data normalization", "value": 1}
                        # ]),
                        # html.Hr(),
                        # dbc.Checklist(id='[PlotsOfData/DataSummary]ShowInformation', options=[
        ...
        dbc.Col([
            ...
            html.Div([
                dash_table.DataTable(
                    id="[PlotsOfData/DataSummary]show_data",
...
@app.callback(
    Output("[PlotsOfData/DataSummary]show_data", "columns"),
    Output("[PlotsOfData/DataSummary]show_data", "data"),
    Input("[PlotsOfData/DataSummary]check_show", "value"),
    State("[PlotsOfData]data_input", "data"),
    Input("[PlotsOfData/DataSummary]digits", "value"),
...
def change_data(value, data_file_content_store, digits_store, data_tiny_store):
    ...
    data_input = data_input.select_dtypes(include=['number'])
    ...
    columns = [{"name": i, "id": i} for i in ["Condition", "n"]]
